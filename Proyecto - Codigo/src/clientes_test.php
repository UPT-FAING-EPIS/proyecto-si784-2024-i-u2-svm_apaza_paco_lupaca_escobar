<?php 
include_once "includes/header_test.php";
include "../conexion.php";
include "ClienteModelTest.php";
...
if (!empty($_POST)) {
    ...
    if (empty($_POST['nombre']) || empty($_POST['telefono']) || empty($_POST['direccion'])) {
        ...
        $alert = $clienteModel->registrarCliente($_POST['nombre'], $_POST['telefono'], $_POST['direccion'], $_SESSION['idUser']);
    }
